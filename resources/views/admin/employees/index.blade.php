    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="md:flex md:items-center md:justify-between mb-6">
            <div class="min-w-0 flex-1">
                ...
                <p class="mt-1 text-sm text-gray-500">Database lengkap pegawai aktif Semen Tonasa.</p>
            </div>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-primary-50">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-left text-xs font-bold text-primary-700 uppercase">Band</th>
                        </tr>
                    </thead>
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-red-50 transition">
                            ...
                            <td class="px-6 py-4 text-sm text-gray-600 font-medium">{{ $emp->band ?? '-' }}</td>
                        </tr>
                                            ...
                                            <div class="md:col-span-3 flex flex-col gap-4">
                                                <div class="bg-white p-3 rounded-lg shadow-sm border border-gray-200">
                                                    <div class="text-center mb-2">
                                                        <span class="text-xs font-bold bg-primary-100 text-primary-700 px-2 py-1 rounded-full uppercase">Foto Profil</span>
                                                    </div>
                                                ...
                                                <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                                                    ...
                                                    <div class="divide-y text-sm">
                                                        ...
                                                        <div class="grid grid-cols-3 px-6 py-3 bg-gray-50">
                                                            ...
                                                            <span class="col-span-2 text-blue-600 font-medium">
                                                                {{ $emp->email ?? '-' }}
                                                            </span>
                                                        </div>
