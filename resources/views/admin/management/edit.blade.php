    ...
    <div class="bg-white shadow-lg overflow-hidden sm:rounded-lg p-8">
        ...
        <div class="flex justify-between items-center mb-8 border-b pb-4">
            <h2 class="text-2xl font-bold text-gray-800">
                Edit Karyawan: <span class="text-blue-600">{{ $employee->nama }}</span>
            </h2>
        ...
        <form action="{{ route('employee-management.update', $employee->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="sap_id" value="{{ old('sap_id', $employee->sap_id) }}" required 
                    ...
                    <div>
                        <div class="flex justify-between items-center mb-1">
                            ...
                            <label class="flex items-center text-[10px] text-blue-700 cursor-pointer bg-blue-50 px-2 py-0.5 rounded border border-blue-100 hover:bg-blue-100 transition">
                                <input type="radio" name="primary_phone" value="no_hp_1" class="mr-1 accent-blue-600" 
                                    {{ (old('primary_phone', $employee->primary_phone ?? 'no_hp_1') == 'no_hp_1') ? 'checked' : '' }}> Set Utama
                            </label>
                        </div>
                        <input type="text" name="no_hp_1" value="{{ old('no_hp_1', $employee->no_hp_1) }}" 
                        ...
                        <div>
                            <div class="flex justify-between items-center mb-1">
                                ...
                                <label class="flex items-center text-[10px] text-blue-700 cursor-pointer bg-blue-50 px-1 py-0.5 rounded border border-blue-100 hover:bg-blue-100 transition">
                                    <input type="radio" name="primary_phone" value="no_hp_2" class="mr-1 accent-blue-600" 
                                        {{ (old('primary_phone', $employee->primary_phone) == 'no_hp_2') ? 'checked' : '' }}> Utama
                                </label>
                            </div>
                            <input type="text" name="no_hp_2" value="{{ old('no_hp_2', $employee->no_hp_2) }}" class="w-full border-gray-300 rounded-md text-sm p-2 border">
                        </div>
                        <div>
                            <div class="flex justify-between items-center mb-1">
                                <label class="block text-xs font-bold text-gray-700 uppercase">No HP 3</label>
                                <label class="flex items-center text-[10px] text-blue-700 cursor-pointer bg-blue-50 px-1 py-0.5 rounded border border-blue-100 hover:bg-blue-100 transition">
                                    <input type="radio" name="primary_phone" value="no_hp_3" class="mr-1 accent-blue-600" 
                                        {{ (old('primary_phone', $employee->primary_phone) == 'no_hp_3') ? 'checked' : '' }}> Utama
                                </label>
                            </div>
                            <input type="text" name="no_hp_3" value="{{ old('no_hp_3', $employee->no_hp_3) }}" class="w-full border-gray-300 rounded-md text-sm p-2 border">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="jabatan" value="{{ old('jabatan', $employee->jabatan) }}" class="w-full border-gray-300 rounded-md text-sm p-2 border">
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-700 uppercase mb-1">Position Code</label>
                        <input type="text" name="position_code" value="{{ old('position_code', $employee->position_code) }}" class="w-full border-gray-300 rounded-md text-sm p-2 border">
                    </div>
                      <div>
                        <label class="block text-xs font-bold text-gray-700 uppercase mb-1">Band</label>
                        <input type="text" name="band" value="{{ old('band', $employee->band) }}" class="w-full border-gray-300 rounded-md text-sm p-2 border">
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-700 uppercase mb-1">Unit Kerja (Biro)</label>
                        <input type="text" name="unit_kerja" value="{{ old('unit_kerja', $employee->unit_kerja) }}" class="w-full border-gray-300 rounded-md text-sm p-2 border">
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-700 uppercase mb-1">Seksi</label>
                        <input type="text" name="seksi" value="{{ old('seksi', $employee->seksi) }}" class="w-full border-gray-300 rounded-md text-sm p-2 border">
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-700 uppercase mb-1">Departemen</label>
                        <input type="text" name="departemen" value="{{ old('departemen', $employee->departemen) }}" class="w-full border-gray-300 rounded-md text-sm p-2 border">
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-700 uppercase mb-1">Direktorat</label>
                        <input type="text" name="direktorat" value="{{ old('direktorat', $employee->direktorat) }}" class="w-full border-gray-300 rounded-md text-sm p-2 border">
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-700 uppercase mb-1">Cost Center</label>
                        <input type="text" name="cost_ctr" value="{{ old('cost_ctr', $employee->cost_ctr) }}" class="w-full border-gray-300 rounded-md text-sm p-2 border">
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-700 uppercase mb-1">Subgroup</label>
                        <input type="text" name="subgroup" value="{{ old('subgroup', $employee->subgroup) }}" class="w-full border-gray-300 rounded-md text-sm p-2 border">
                    </div>
                </div>
            </div>
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div>
                        ...
                        <input type="text" name="tempat_lahir" value="{{ old('tempat_lahir', $employee->tempat_lahir) }}" class="w-full border-gray-300 rounded-md text-sm p-2 border">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" name="agama" value="{{ old('agama', $employee->agama) }}" class="w-full border-gray-300 rounded-md text-sm p-2 border">
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-700 uppercase mb-1">Pendidikan</label>
                        <input type="text" name="pendidikan" value="{{ old('pendidikan', $employee->pendidikan) }}" class="w-full border-gray-300 rounded-md text-sm p-2 border">
                    </div>
                    <div class="md:col-span-2">
                        <label class="block text-xs font-bold text-gray-700 uppercase mb-1">Alamat Lengkap</label>
                        <textarea name="alamat" rows="2" class="w-full border-gray-300 rounded-md text-sm p-2 border">{{ old('alamat', $employee->alamat) }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <input type="date" name="date_terminasi" value="{{ old('date_terminasi', $employee->date_terminasi ? $employee->date_terminasi->format('Y-m-d') : '') }}" class="w-full border-gray-300 rounded-md text-sm p-2 border">
                    </div>
                    
                    {{-- MASA KERJA: READONLY --}}
                    <div>
                        <label class="block text-xs font-bold text-gray-700 uppercase mb-1">Masa Kerja (Otomatis)</label>
                        <input type="text" value="{{ $employee->masa_kerja }} Tahun" disabled class="w-full bg-gray-100 text-gray-500 border-gray-300 rounded-md text-sm p-2 border cursor-not-allowed">
                    </div>
                </div>
            </div>
            ...
            <div class="mb-8">
                <h3 class="text-lg font-bold text-blue-900 border-l-4 border-blue-600 pl-3 mb-4 bg-gray-50 p-2">5. Update Foto</h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        @if($employee->foto_terbaru)
                            <div class="mb-2">
                                <img src="{{ asset('storage/'.$employee->foto_terbaru) }}" class="h-24 w-20 object-cover rounded border shadow-sm" alt="Foto Terbaru">
                                <p class="text-[10px] text-green-600 mt-1">Foto saat ini</p>
                            </div>
                        @endif
